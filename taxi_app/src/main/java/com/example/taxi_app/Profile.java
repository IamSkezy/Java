...
public class Profile implements Initializable {
    ...
    public void clientRegister(ActionEvent event) throws IOException {
        ...
        register.getIcons().add(new Image("taxi_logo.png"));
        register.setTitle("Служба Такси");
    ...
    public void addService(ActionEvent event) throws IOException {
        ...
        addService.getIcons().add(new Image("taxi_logo.png"));
        addService.setTitle("Служба Такси");
    ...
    public void enterOrder(ActionEvent event) throws IOException {
        ...
        formOrder.getIcons().add(new Image("taxi_logo.png"));
        formOrder.setTitle("Служба Такси");
    ...
    public void showClients(ActionEvent event) throws IOException {
        ...
        histStage.getIcons().add(new Image("taxi_logo.png"));
        histStage.setTitle("Служба Такси");
    ...
    public void addEmployee(ActionEvent event) throws IOException {
        ...
        addEmployee.getIcons().add(new Image("taxi_logo.png"));
        addEmployee.setTitle("Служба Такси");
    ...
    public void exit(ActionEvent event) throws IOException {
        ...
        st3.getIcons().add(new Image("taxi_logo.png"));
        st3.setTitle("Служба Такси");
